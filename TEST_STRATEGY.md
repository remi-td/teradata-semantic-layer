...
sub-SELECT pattern is future work (documented in WORKFLOW_REVIEW).
...
The runner writes a markdown report (default `TEST_RESULTS.md` at the repo
root). Each case section contains:
