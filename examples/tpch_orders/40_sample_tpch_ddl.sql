-- =========================================================================
-- Sample TPC-H physical tables (small synthetic dataset).
--
-- Tables are created unqualified and land in the session default database
-- (the catalog DB, set by DATABASE_URI). The catalog metadata is retargeted
-- to the same DB by 42_retarget_catalog.sql after this file runs.
-- =========================================================================

CREATE MULTISET TABLE region, FALLBACK (
...
CREATE MULTISET TABLE nation, FALLBACK (
...
CREATE MULTISET TABLE customer, FALLBACK (
...
CREATE MULTISET TABLE orders, FALLBACK (
...
CREATE MULTISET TABLE lineitem, FALLBACK (
...
CREATE MULTISET TABLE part, FALLBACK (
...
CREATE MULTISET TABLE supplier, FALLBACK (
...
CREATE MULTISET TABLE partsupp, FALLBACK (
